...
export interface EternaInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "allowance"
      | "approve"
...
export interface Eterna extends BaseContract {
  connect(runner?: ContractRunner | null): Eterna;
  waitForDeployment(): Promise<this>;

  interface: EternaInterface;
